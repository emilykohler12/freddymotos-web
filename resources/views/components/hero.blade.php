...
<section class="relative flex w-full flex-col overflow-hidden bg-gradient-to-br from-marca-mostaza via-marca-amarillo to-marca-amarillo lg:min-h-[92vh]">
    ...
    <div class="relative z-10 mx-auto grid w-full max-w-7xl flex-1 grid-cols-1 items-center gap-10 px-4 pb-20 pt-6 sm:px-6 lg:grid-cols-2 lg:gap-10 lg:px-8 lg:pb-28 lg:pt-12">
        ...
        <div class="relative lg:-mr-4">
            ...
            {{-- Foto del hero: la que cargue el admin en Configuración tiene prioridad; si no, la foto fija de la moto que siempre va acá (bundled en el repo, no depende de que el admin suba nada). --}}
            <img src="{{ $settings->hero_photo_url ?? asset('images/hero-moto.jpg') }}" alt="{{ $nombre }}" class="relative mx-auto aspect-[16/10] w-full max-w-xl rounded-3xl object-cover drop-shadow-2xl">
        </div>
    </div>
