    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div class="max-w-xl text-marca-negro">
            ...
            @if ($settings->maps_url)
                <a href="{{ $settings->maps_url }}" target="_blank" rel="noopener" class="mt-8 inline-flex items-center justify-center rounded-full bg-marca-negro px-7 py-3 text-sm font-bold text-marca-blanco transition hover:bg-marca-bordo">
                    Conocé la tienda
                </a>
            @endif
        </div>
