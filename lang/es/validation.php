...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado aparece en una filtración de datos conocida. Elegí otro :attribute.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres en español para que los mensajes de arriba queden legibles
    | en todo el sitio (público y panel admin) sin repetir esto en cada form.
    |
    */
    ...
    'attributes' => [
        ...
        'image' => 'imagen',
        'logo' => 'logo',
        'compatible_model' => 'modelo compatible',
